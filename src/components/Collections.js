...
const Collections = (props) => {
  ...
  const trendingUrl = `https://api.themoviedb.org/3/trending/movie/week?api_key=b62c0f91291c936ed5ed4220675afec3`;
  const nowPlayingUrl = `https://api.themoviedb.org/3/movie/now_playing?api_key=b62c0f91291c936ed5ed4220675afec3&language=en-US&page=1`;
  const topRatedUrl = `https://api.themoviedb.org/3/movie/top_rated?api_key=b62c0f91291c936ed5ed4220675afec3&language=en-US&page=1`;
  const upcomingUrl = `https://api.themoviedb.org/3/movie/upcoming?api_key=b62c0f91291c936ed5ed4220675afec3&language=en-US&page=1`;
