...
const App = () => {
  ...
  const [activeUrl, setActiveUrl] = useState(
    'https://api.themoviedb.org/3/trending/movie/week?api_key=b62c0f91291c936ed5ed4220675afec3'
  );
  ...
  const searchUrl = `https://api.themoviedb.org/3/search/movie?api_key=b62c0f91291c936ed5ed4220675afec3&query=${searchedMovie}`;
  ...
  const movieDetailsUrl = `https://api.themoviedb.org/3/movie/${movieId}?api_key=b62c0f91291c936ed5ed4220675afec3&append_to_response=credits`;
